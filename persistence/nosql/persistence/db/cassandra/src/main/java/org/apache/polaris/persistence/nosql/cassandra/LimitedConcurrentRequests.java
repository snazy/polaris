...
/**
 * Synchronization helper for asynchronous "child" queries for {@link
 * CassandraPersistence#deleteMany(ObjRef[])}, {@link Persistence#writeMany(Class, Obj[])}.
 *
