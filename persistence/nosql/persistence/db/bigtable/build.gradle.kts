...
dependencies {
  ...
  compileOnly(libs.quarkus.google.cloud.bigtable)
  add("quarkusRuntimeOnly", platform(libs.quarkus.bom))
  add("quarkusRuntimeOnly", libs.quarkus.google.cloud.bigtable)
  ...
  testFixturesImplementation(platform(libs.google.cloud.bigtable.bom))
  testFixturesImplementation("com.google.cloud:google-cloud-bigtable")
