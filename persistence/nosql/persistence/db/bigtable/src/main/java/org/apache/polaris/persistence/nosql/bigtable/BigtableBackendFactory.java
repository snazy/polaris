...
public class BigtableBackendFactory
  ...
  public BigtableBackendConfig buildConfiguration(BigtableConfiguration config) {
    return buildConfiguration(config, NoCredentialsProvider.create());
  }

  public BigtableBackendConfig buildConfiguration(
      BigtableConfiguration config, CredentialsProvider credentialsProvider) {
    try {
