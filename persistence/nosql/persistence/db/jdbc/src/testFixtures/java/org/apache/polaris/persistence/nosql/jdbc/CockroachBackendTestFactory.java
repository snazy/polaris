...
public class CockroachBackendTestFactory extends BaseJdbcContainerBackendTestFactory {

  public static final String NAME = JdbcBackendFactory.NAME + "-Cockroach";
  ...
  public JdbcIsolation jdbcIsolation() {
    // Required for Cockroach
    return JdbcIsolation.SERIALIZABLE;
  }
