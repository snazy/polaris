  ...
  public MaintenanceRunInformation performMaintenance(
    ...
    try {
      try {
        ...
        // the object types that shall be purged, even if the obj-type is unknown, to clean up after
        // an extension/plugin that used those object-types is no longer being used.
