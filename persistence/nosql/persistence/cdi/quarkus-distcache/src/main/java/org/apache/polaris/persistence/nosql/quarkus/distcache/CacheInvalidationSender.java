 ...
 *
 * <p>This bean is automatically initialized via the {@code @Observes} annotation, and automatically
 * injected via the implemented {@link DistributedCacheInvalidation.Sender} interface.
 */
@ApplicationScoped
@Startup
